...
import { FollowingScreenNavigationProp } from '../../types';
          ...
          <View style={styles.card} key={follower.login}>
            <View style={styles.row}>
              <Avatar
                ...
                onPress={() => { navigation.push('ProfileScreen', { userId: follower?.login }); }}
              />
              {follower?.name ? (
                <Text style={styles.title}>
                  {
 ...
 */
const FollowingView = (props: Props) => {
  ...
  return (
    <View>
      <FollowingList data={data} navigation={navigation} />
    </View>
  );
};
